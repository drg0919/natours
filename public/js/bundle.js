...
var showAlert = function showAlert(type, msg) {
  hideAlert();
  var className = "<div class=\"alert alert--".concat(type, "\">").concat(msg, "</div>");
...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("".concat(loc.description, "</p>")).addTo(map);
    bounds.extend(loc.coordinates);
  });
...
exports.updatePassword = exports.updateSettings = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.patch('http://localhost:3000/api/v1/users/updateMe', data);

          case 3:
            res = _context.sent;
            if (res.data.status === 'success') (0, _alert.showAlert)('success', "Your credentials have been updated");else (0, _alert.showAlert)('error', "Something went wrong");
            _context.next = 10;
            break;
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            (0, _alert.showAlert)('error', 'Try again later');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _axios.default.patch('http://localhost:3000/api/v1/users/changepassword', {
          ...
          case 3:
            ...
            } else (0, _alert.showAlert)('error', "Something went wrong");
...
var stripe = Stripe('pk_test_DfFkqUNC1M8DE14UtWZWeClP00raiKKLnY');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.get("http://localhost:3000/api/v1/bookings/checkout/".concat(tourID));
...
var userUpdate = document.querySelector('.form-user-data');
var userUpdatePassword = document.querySelector('.form-user-password');
var bookButton = document.querySelector('#booktour');
...
if (userUpdate) {
  userUpdate.addEventListener('submit', function (e) {
    ...
    (0, _updateSettings.updateSettings)(form); // const name = document.getElementById('name').value;
...
if (userUpdatePassword) {
  userUpdatePassword.addEventListener('submit',
  /*#__PURE__*/
  function () {
    var _ref = _asyncToGenerator(
    /*#__PURE__*/
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 7;
              return (0, _updateSettings.updatePassword)(currentPassword, newPassword, confirmNewPassword);
...
if (bookButton) bookButton.addEventListener('click', function (eve) {
  eve.target.textContent = 'Processing';
  var tourId = eve.target.dataset.tourId;
